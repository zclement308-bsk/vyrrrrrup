...
export const questions: Question[] = [
  ...
  { id: 'views', eyebrow: 'TA PORTÉE ACTUELLE', title: 'Combien de vues fais-tu en moyenne ?', subtitle: 'Une estimation suffit, on confirmera ensuite les vrais chiffres.', skipIf: (a) => a.experience === 'Quelques semaines', options: [{ label: 'Moins de 1 000', icon: Eye }, { label: '1 000 à 10 000', icon: Eye }, { label: '10 000 à 100 000', icon: TrendingUp }, { label: 'Plus de 100 000', icon: Rocket }] },
  { id: 'virality', eyebrow: 'TA MÉTHODE', title: 'Utilises-tu des techniques de viralité ?', subtitle: 'Hooks, rétention, rythme : où en es-tu vraiment ?', skipIf: (a) => a.experience === 'Quelques semaines', options: [{ label: "Non, je n'en connais aucune", icon: X }, { label: 'Oui, mais ça ne fonctionne pas', icon: Lightbulb }, { label: 'Parfois, sans vraie méthode', icon: Repeat2 }, { label: 'Oui, avec de bons résultats', icon: Check }] },
  ...
  { id: 'platform', eyebrow: 'TON TERRAIN DE JEU', title: 'Où publies-tu le plus ?', subtitle: 'On adapte le diagnostic à ton canal principal.', options: [{ label: 'TikTok', icon: TikTokIcon }, { label: 'Instagram', icon: InstagramIcon }] },
